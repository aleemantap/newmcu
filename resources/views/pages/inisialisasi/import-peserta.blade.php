                ...
                <div class="modal-body">
                    ...
                    <div class="input-form">
                        <div class="form-group row">
                            <div class="alert alert-info"><i class="fa fa-info-circle"></i> Sebelum melakukan impor data, pastikan template excel yang digunakan sudah benar. Silakan unduh template di sini. <a href="{{ asset('template/template_peserta.xlsx') }}"><strong>Unduh template</strong></a>.</div>
