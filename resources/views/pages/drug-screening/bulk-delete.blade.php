<div class="modal fade" id="modal-delete-drugscreening">
        ...
        <div class="modal-content" style="width:36rem;">
            ...
            <form class="form-horizontal" id="form-drugscreening">
                <div class="modal-header bg-dark no-border">
                    <h4 class="modal-title">@lang('general.bulk_delete') Drug Screening</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control form-control-sm" id="customer-bulk">
                    ...
                    <div class="form-group row">
                        <input type="hidden" class="form-control form-control-sm" id="drugscreening-id">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-default btns-sm btn-flat" data-dismiss="modal">@lang('general.close')</button>
                </div>
            </form>
        </div>
    </div>
