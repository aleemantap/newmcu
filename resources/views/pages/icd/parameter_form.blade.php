            ...
            <form class="form-horizontal" id="form-rontgen" action="{{url('/database/rontgen-export')}}" method="post">
                ...
                <div class="modal-body">
					...
					<div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input  type="hidden" class="form-control input-xs" name="parameter_id" id="parameter-id">
                            <input  type="text" class="form-control input-xs" name="nama_parameter" id="nama_parameter">
                        </div>
                    </div>
					<div class="form-group row">
                        <label for="" class="control-label col-md-4">Field</label>
                        <div class="col-md-8">
                            <input  type="text" class="form-control input-xs " name="field" id="field">
                        </div>
                    </div>
					<div class="form-group row">
                        <label for="" class="control-label col-md-4">Index Excel</label>
                        <div class="col-md-8">
                            <input  type="text" class="form-control input-xs " name="excelindex" id="excelindex">
                        </div>
                    </div>
				    <div class="form-group row">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="btn-submit-parameter"><i class="fa fa-check-circle"></i> @lang('general.submit')</button>
