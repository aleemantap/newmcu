<div class="modal fade" id="modal-publish">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="form-rontgen" action="" method="post">
                @csrf
                ...
                <div class="modal-body"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control form-control-sm" id="bagian">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-5"><input disabled="" type="text" class="form-control form-control-sm datepicker" name="startDate" id="from-date"></div>
                                <label class="col-md-2 control-label">To</label>
                                <div class="col-md-5"><input disabled="" type="text" class="form-control form-control-sm datepicker" name="endDate" id="to-date"></div>
                            </div>
                        </div>
                    </div>
					<div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-6"><input disabled="" type="text" placeholder="From" class="form-control form-control-sm" name="startId" id="start-id"></div>
                                
                                <div class="col-md-6"><input disabled="" type="text" placeholder="To" class="form-control form-control-sm" name="toId" id="to-id"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-flat" id="btn-publish"><i class="fa fa-check-circle"></i> @lang('general.submit')</button>
                    <button class="btn btn-default btn-flat" data-dismiss="modal">@lang('general.close')</button>
                </div>
            </form>
        </div>
    </div>
