        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="form-rontgen">
                <div class="modal-header bg-dark no-border">
                    <h4 class="modal-title">Filter Audiometri</h4>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-flat btn-sm" id="btn-filter"><i class="fa fa-check-circle"></i> @lang('general.submit')</button>
