...
$(document).ready(function () {
    ...
    var dataTable = $('#datatable').DataTable({
        ...
        columnDefs:[

			{
                targets: 5,
                render: function(d) {
                    return '<a href="#" class="btn btn-warning btn-xs btn-edit-parameter btn-flat" title="Edit" data-id='+d+'><i class="fa fa-pencil"></i></a>&nbsp; <button type="button" class="btn btn-danger btn-xs btn-delete-parameter btn-flat" title="@lang('general.delete')" data-id='+d+'><i class="fa fa-trash"></i></button>';
                }
            }
	...
	// Create button
    $("div.toolbar").html('<a href="#" id="btn-add-prm" class="btn btn-primary btn-flat btn-sm"><i class="fa fa-plus-circle"></i> @lang("general.add")</a>');
...
function kategori(value)
{
	...
	var  s = "<select class='operator form-control form-control-sm input-xs' id='kategori_pr' name='kategori_pr' >";
