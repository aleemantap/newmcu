            ...
            <form class="form-horizontal" id="form-rontgen" action="{{url('/database/medical-check-up/export')}}" method="post">
                ...
                <div class="modal-body px-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control form-control-sm" id="customerx" name="idPerusahaan">
                    ...
                    {{-- <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control form-control-sm" id="customer-" name="idPerusahaan">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary btn-sm" id="btn-export"><i class="fa fa-check-circle"></i> @lang('general.submit')</button>
