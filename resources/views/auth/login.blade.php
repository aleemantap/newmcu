@extends('auth.app')
@section('title', 'Login GMeds System')
@section('content')
<style>
    body {
    color: #000;
            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    <div class="row mb-4 px-3">
                        <h6 class="mb-0 mr-4 mt-2">Login to e-MCU GMeds Report System </h6>
                    ...
                    <form align="center" action="{{ url('login') }}" id="login-form" class="smart-form client-form" method="post">
                            @csrf
                            <div class="row px-3">
                                <label class="mb-1"><h6 class="mb-0 text-sm">Email Address</h6></label>
                                <input class="mb-4" id="email" type="text" class="form-control  {{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus placeholder="Enter a valid email address">
                            ...
                            <div class="row px-3 mb-4">
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input id="remember" type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }} class="custom-control-input"> 
