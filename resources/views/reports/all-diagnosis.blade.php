...
$(document).ready(function () {
	...
	$('#btn-dwn').click(function() {
		...
		$.ajax({
            url: baseUrl+"/report/all-diseases/export",
            type: 'POST',
			contentType: false,
			processData: false,
			cache: false,
    ...
    var dataTable = $('#datatable').DataTable({
        ...
        ajax: {
            url: baseUrl+"/report/all-diseases-datatables",
            type: 'GET',
            data:  function(d){
			var idPer = '';
			if($('#perusahaan').val()==''|| $('#perusahaan').val()==undefined)
        ...
        columns: [
            ...
            {data: "TL", name: "TL"},
            {data: "TP", name: "TP"},
            {data: "bawah_tigapuluh", name: "bawah_tigapuluh"},
            {data: "tigapuluh_sd_empatpuluh", name: "tigapuluh_sd_empatpuluh"},
            {data: "atas_empatpuluh", name: "atas_empatpuluh"},
        ...
        columnDefs:[
            {
                ...
                render: function(d, type, row) {
					...
					return '<a href="/report/diseases-detail/'+d+'/'+row.total+'/All Diseases/'+filter+'" class="btn btn-action btn-primary btn-xs" data-id="'+d.id+'"><i class="fa fa-ellipsis-h"></i></a>&nbsp;';
