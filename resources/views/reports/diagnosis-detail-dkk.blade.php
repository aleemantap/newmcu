...
<ul class="breadcrumbs pull-left">
    ...
    <li><a>{{ $parentMenu }}</a></li>
    <li><a>{{ $code }} - {{ $diagnosis }} (Total {{$total}})</a></li>
    <li><span>{{$wh}}</span></li>
</ul>
@endsection

@section('content')
<input type="hidden" id="wh_id" value="{{$wh_id}}">
                    ...
                    <div class="form-filter">
                        ...
                        <form action="" class="form-horizontal">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        <label for="" class="control-label col-md-4">Diagnosis</label>
                                        <div class="col-md-8"><input type="text" class="form-control form-control-sm" readonly value="{{$code}} - {{$diagnosis}}"></div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group row">
...
$(document).ready(function () {
    ...
    var dataTable = $('#datatable').DataTable({
        ...
        ajax: {
            url: baseUrl+"/report/diseases-detail-datatables-dkk",
            type: 'GET',
            data:  function(d){
				var idPer = '';
	...
	$('#btn-download-mcu').click(function() {
		 ...
		 $.ajax({
            url: baseUrl+"/report/patient/diseases-detail-dkk/export",
