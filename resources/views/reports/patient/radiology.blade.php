                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control input-xs" id="rontgen">
                                                <option value="">&raquo; @lang('general.all')</option>
                                                <option value="Dalam batas normal">Normal</option>
...
$(document).ready(function () {
	...
	$('#btn-top-dwn').click(function() {
		...
		$.ajax({
            url: baseUrl+"/report/radiology/export",
            type: 'POST',
			contentType: false,
			processData: false,
			cache: false,
    ...
    var dataTable = $('#user-table').DataTable({
        ...
        ajax: {
            url: baseUrl+"/report/patient/radiologi-datatables",
            type: 'GET',
            data:  function(d){
        ...
        columns: [
            ...
            {data: "rontgen.kesan_rontgen", name: "rontgen.kesan_rontgen"},
...
function updateChart() {
    $.ajax({
        url: baseUrl + '/report/patient/radiologi-summary',
        type: 'GET',
        data: {
        ...
        success: function(resp) {
            ...
            $.each(resp, function(i, o) {
                ...
                data.push({
                    name: o.kesan_radiology,
                    color: colors[index],
                    y: o.total
                });
                categories.push(o.kesan_radiology);
            });
