...
@section('ribbon')
    <ul class="breadcrumbs pull-left">
        ...
        <li><span>Elektrokardiografi</span></li>
    </ul>
@endsection
...
<div class="form-filter">
    ...
    <form action="" class="form-horizontal">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group row">
                    <label for="" class="control-label col-md-4">@lang('mcu.ekg')</label>
                    <div class="col-md-8">
                        <select class="form-control input-xs" id="ekg">
                            <option value="">&raquo; @lang('general.all')</option>
                            <option value="Normal EKG">Normal EKG</option>
            ...
            <div class="col-md-8">
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        <button type="button" id="btn-ekg-submit" class="btn btn-xs btn-default btn-block"><i class="fa fa-download"></i> @lang('general.download')</button>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function () {
    ...
    var dataTable = $('#user-table').DataTable({
        ...
        ajax: {
            url: baseUrl+"/report/patient/elektrokardiografi-datatables",
            type: 'GET',
            data:  function(d){
        ...
        columns: [
            ...
            {data: "ekg.kesimpulan_ekg", name: "ekg.kesimpulan_ekg"},
...
function updateChart() {
    $.ajax({
        url: baseUrl + '/report/patient/elektrokardiografi-summary',
        type: 'GET',
        data: {
        ...
        success: function(resp) {
            var data = [];
            var categories = [];
            var colors = ['#006db7', '#da251d'];

            $.each(resp, function(i, o) {
                if(o.result_ekg == 'Normal') {
                    index = 0;
                } else {
                    index = 1;
                }
