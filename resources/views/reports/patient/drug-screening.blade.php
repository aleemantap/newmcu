...
@section('ribbon')
    <ul class="breadcrumbs pull-left">
        ...
        <li><span>Drug Screening</span></li>
    </ul>
@endsection
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <button type="button" class="btn btn-xs btn-default btn-block" id="btn-dw" title="@lang('general.download')"><i class="fa fa-download"></i> @lang('general.download')</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function () {
	...
	$('#btn-dw').click(function() {
        ...
        $.ajax({
            ...
            url: baseUrl+"/report/patient/drug-screening-export", 
    ...
    var userDataTable = $('#user-table').DataTable({
        ...
        ajax: {
            url: baseUrl+"/report/patient/drug-screening-datatables",
            type: 'GET',
            data: function(d) {
        ...
        columns: [
            ...
            {data: "drug_screening.kesimpulan_drug_screening", name: "drugScreening.kesimpulan_drug_screening"},
...
function updateChart() {
    // Update chart
    $.ajax({
        url: baseUrl + '/report/patient/drug-screening-summary',
        type: 'GET',
        data: {
        ...
        success: function(resp) {
            ...
            $.each(resp, function(i, o) {
                data.push({
                    name: o.kesimpulan_drug_screening,
                    color: colors[i],
                    y: o.total
                });
                categories.push(o.kesimpulan_drug_screening);
            });
