...
@section('ribbon')
        <ul class="breadcrumbs pull-left">
            <li><a>Report</a></li>
            <li><a>Pasien</a></li>
            <li><span>Medical Check Up WH Diagnosis</span></li>
        </ul>
@endsection
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8"><input type="text" class="form-control input-xs" id="no-nip"></div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8"><input type="text" class="form-control input-xs datepicker" id="tgl-lahir"></div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <button type="button" class="btn btn-xs btn-default btn-block" id="btn-wh-download"><i class="fa fa-download"></i> @lang('general.download')</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function () {
	...
	$('#btn-wh-download').click(function() {
		...
		$.ajax({
            url: baseUrl+"/report/patient/diagnosa-kesehatan-kerja/export",
            type: 'POST',
			contentType: false,
			processData: false,
			cache: false,
    ...
    var dataTable = $('#user-table').DataTable({
        ...
        ajax: {
            url: baseUrl+"/report/patient/work-health-diagnosis-datatables",
            type: 'GET',
            data:  function(d){
        ...
        columnDefs:[
			{
				...
				render: function(diagnosis) {
					    ...
					    /*if(diagnosis.length === 0 ) {
							...
							//return diagnosis[0].name; //diagnosis.length-1
							console.log(diagnosis[0].recommendation.work_health);
							return diagnosis[diagnosis.length-1].name; //
						}*/
						
				}
			},
            {
                targets: 8, // <a data-id='+d.id+' class="btn btn-action btn-primary btn-xs"><i class="fa fa-plus-circle"></i></a> &nbsp;
                render: function(d) {
                    return `<a href="/report/patient/medical-check-up/detail/`+d+`" class="btn btn-action btn-primary btn-xs" data-id='+d.id+'><i class="fa fa-ellipsis-h"></i></a> &nbsp;
                            ...
                            <a data-id='+d.id+' target="_blank" href="/report/patient/medical-check-up/print/`+d+`" class="btn btn-action btn-outline-dark btn-xs"><i class="fa fa-print"></i></a>`;
                }
            }
        ]
    });
...
function updateChart() {
    // Update chart
    $.ajax({
        url: baseUrl + '/report/patient/diagnosa-kesehatan-kerja-summary?columns[0][data]=id&order[0][column]=asc&order[0][dir]=0',
        type: 'GET',
        data: {
