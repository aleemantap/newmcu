			...
			<table style="width: 100%;">
			    <tr>
					<td style="text-align:right;">
						<div class="" style="margin-right:-440px;font-size:10pt;">
							<div class="table_ttd">
							   <div class="row_ttd">
								  <div class="cell_ttd" style="text-align: center;">
									...
									<!--<div style="height:100px;margin-left:480px">
									    
										<img class="img-sign imgA1" _style="margin-left:40px;" height="90" src="{{ public_path('storage/vendor/'.$data->vendorCustomer->vendor->image) }}" >
										<img class="img-sign imgB1" height="90" src="{{ public_path('storage/vendor/'.$data->vendorCustomer->vendor->sign) }}" >
				...
				<tbody>
					<tr>
						...
						<td style="" width="50%">
							<table class="tb_he">
								<tbody>
									<tr><td width="60%" valign="top">No Paper</td><td class="td_1" valign="top">{{$data['no_paper']}}</td></tr>
									<tr><td width="60%" valign="top">Medical ID#</td><td class="td_1" valign="top">{{$data['id']}}</td></tr>
