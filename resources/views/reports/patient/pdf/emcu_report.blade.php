		    ...
		    <legend class="legend1">Kimia Darah Dan Sputum</legend>
				<table cellspacing="0"  style="width:100%;margin-top:2px;margin-left:10px;margin-right:10px;margin-bottom:5px;">
					<tbody>
						...
						<tr style="">
							<td width="15%">HDL</td>
							<td style="" width=""><?php echo ReportHelp::AsamUrat($data->kimia?$data->kimia->hdl:'',$data['jenis_kelamin']);?></td>
						...
						<tr>
							...
							<td style="" width=""><?php echo ReportHelp::HBSAg($data->serologi?$data->serologi->anti_hbs:'');?></td>
							<td style="" width="">(Non Reaktif)</td>
