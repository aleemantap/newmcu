	  ...
	  <main>
				...
				<tbody>
					<tr>
						<td width="50%" style="text-align: center;">							
								<img width="100" src="{{$logo}}" style="margin-left:-100px;"/>
				     	</td>
						...
						<td style="" width="50%">
							<table class="tb_he">
								<tbody>
									<tr>
										<td width="50%" valign="top">Medical ID</td>
										<td width="50%" class="td_1" valign="top">{{$data['id']}}</td>
									</tr>
									<tr>
										<td width="50%" valign="top">Nama</td>
										<td width="50%" class="td_1" valign="top">{{$data['nama_pasien']}}</td>
									</tr>
									<tr>
	    ...
	    <div class="title_head" style="height: 620px;">
			...
			<table class="table2"  cellspacing="0">
				<tbody>
					...
					<tr>
						<td colspan="3"><b>Catatan </b><p>{{$data['catatan']}}</p></td>
					</tr>
					<tr>
						<td  colspan="3"><b>Saran</b><p>{{$data['saran']}}</p></td>
					</tr>
					<tr>
						<td  colspan="3"><b>Diagnosis Kerja</b></td>
					</tr>
					<tr>
		...
		<footer>
			<table style="width: 700px;">
			    <tr>
			     	<td style="text-align:left;">
					    <div class="" style="margin-left:-20px;font-size:10pt;">					    
					...
					<td xstyle="text-align:right;">
						<div class="" style="margin-right:-80px;font-size:10pt;">
            ...
            <div style="text-align:center; width:700px;">
                <div class="footx" style="margin-top:20px;margin-right:160px;">
					...
					<tr>
						...
						<td style="" width="50%">
							<table class="tb_he">
								<tbody>
									<tr>
										<td width="50%" valign="top">No Paper</td>
									    
										<td class="td_1" valign="top">{{$data['no_paper']}}</td>
									</tr>
									<tr><td width="50%" valign="top">Medical ID#</td><td class="td_1" valign="top">{{$data['id']}}</td></tr>
									<tr><td width="50%" valign="top">Nama</td><td class="td_1" valign="top">{{$data['nama_pasien']}}</td></tr>
									<tr><td width="50%" valign="top">Jenis Kelamin</td><td class="td_1">{{ ($data['jenis_kelamin']=='P') ? 'PEREMPUAN' : 'LAKI-LAKI'  }}</td></tr>
									<tr><td width="50%" valign="top">Tanggal Lahir</td><td class="td_1">{{date("d/m/Y", strtotime($data['tgl_lahir']))}}</td></tr>
									<tr><td width="50%" valign="top">NIP</td><td class="td_1">{{$data['no_nip']}}</td></tr>
									<tr><td width="50%" valign="top">Bagian</td><td class="td_1">{{$data['bagian']}}</td></tr>
									<tr><td width="50%" valign="top">Perusahaan</td><td class="td_1">{{ $data->vendorCustomer->customer->name }}</td></tr>
								</tbody>
		    ...
		    <table cellspacing="0"  style="width:100%;margin-top:-1px;margin-left:10px;margin-right:10px;margin-bottom:5px;">
					   <tbody>
							...
							<tr style="">
								...
								<td style="" width=""><span style="font-size:11px;">27-31 Pgrams/sel</span></td>
							</tr>
							<tr>
		    ...
		    <legend class="legend1">Kimia Darah Dan Sputum</legend>
				<table cellspacing="0"  style="width:100%;margin-top:2px;margin-left:10px;margin-right:10px;margin-bottom:5px;">
					<tbody>
						...
						<tr style="">
							<td width="15%">HDL</td>
							<td style="" width=""><?php echo \App\Helpers\ReportHelp::AsamUrat($data->kimia?$data->kimia->hdl:'',$data['jenis_kelamin']);?></td>
						...
						<tr>
							...
							<td style="" width=""><?php echo \App\Helpers\ReportHelp::HBSAg($data->serologi?$data->serologi->anti_hbs:'');?></td>
							<td style="" width="">(Non Reaktif)</td>
							...
							<table cellpadding="7" cellspacing="0" style="width:100%">
								<tbody>
									...
									<tr>
										...
										<td><span style="font-style:bold;">(<?php if($data->serologi->hbsag=='Reaktif'){ $n = 'Negatif'; } else { $n='Positif';} ?>{{$n}})</span></td>
									</tr>
									<tr>
										...
										<td><span style="font-style:bold;">(<?php if($data->serologi->hbsag=='Non Reaktif'){ $na = 'Negatif'; } else { $na='Positif';} ?>{{$na}})</span></td>
									</tr>
									<tr>
		...
		<div id="azzz" style="margin-left:15px;  width: 100%; height: 285px;">
		...
		<div style=" margin-left:10px;margin-right:10px;margin-top:90px;;">
	 ...
	 @if($data->papSmear)
		...
		<div style=" margin-left:10px;margin-right:10px;">
			...
			<div style="margin-left:15px;
						...
						padding-bottom:15px;
						font-size:12pt;
						">{{ $data->drugScreening? $data->drugScreening->kesimpulan_drug_screening : ''}}</div>
