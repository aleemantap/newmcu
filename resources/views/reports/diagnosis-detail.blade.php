...
<ul class="breadcrumbs pull-left">
    <li>Report</li>
    <li><a href="/report/all-diseases">{{ $parentMenu }}</a></li>
    <li><span>{{ $code }} - {{ $diagnosis }} (Total {{$total}})</span></li>
</ul>
@endsection
                ...
                <div class="card-body">
                    ...
                    <div class="form-filter">
                        ...
                        {{-- <div style="width: 100%;display: flex; height:40px;"> --}}
                            {{-- <div style="width: 50%;"> --}}
                                <a class="hide" href="#">
                                    <i class="fa fa-chevron-down sign"></i>
                                        <span class="filter-title">Show</span><span class="filter-title hidden">Hide</span> Filter
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <input type="hidden" class="form-control input-xs" id="code" value="{{ $code }}">
                                        <label for="" class="control-label col-md-4">@lang('mcu.input_date')</label>
                                        <div class="col-md-8">
                                            <div class="input-group input-daterange">
                                                <input value="{{($startDate)?$startDate:''}}" type="text" class="form-control form-control-sm input-xs" id="from-date" data-provide="datepicker" style="border-right-width: 1px">
                                                <div  class="input-group-addon">&nbsp;-&nbsp;</div>
                                                <input value="{{($endDate)?$endDate:''}}" type="text" class="form-control form-control-sm input-xs" id="to-date" data-provide="datepicker">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8"><input type="text" class="form-control form-control-sm input-xs" id="id-pasien"></div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        <label for="" class="control-label col-md-4">No. NIP</label>
                                        <div class="col-md-8"><input type="text" class="form-control form-control-sm input-xs" id="no-nip"></div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        <label for="" class="control-label col-md-4">Nama</label>
                                        <div class="col-md-8"><input type="text" class="form-control form-control-sm input-xs" id="nama"></div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        <label for="" class="control-label col-md-4">Tgl. Lahir</label>
                                        <div class="col-md-8"><input type="text" class="form-control form-control-sm input-xs datepicker" id="tgl-lahir"></div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        <label for="" class="control-label col-md-4">Dianogis</label>
                                        <div class="col-md-8"><input type="text" class="form-control form-control-sm input-xs" readonly value="{{$code}} - {{$diagnosis}}"></div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group row">
...
$(document).ready(function () {
	  ...
	  var vl ="<?php echo $klient;?>";
	  var lp ="<?php echo $sex;?>";
	  var vendor ="<?php echo $vendor;?>";
	  var per ="<?php echo $perusahaan;?>";
	  
	  $("#client").val(vl).trigger('change');
	  $("#lp").val(lp).trigger('change');
	  $("#vendor").val(vendor).trigger('change');
	  $("#perusahaan").val(per).trigger('change');
    ...
    var dataTable = $('#datatable').DataTable({
        ...
        ajax: {
            url: baseUrl+"/report/diseases-detail-datatables",
            type: 'GET',
            data:  function(d){
				var idPer = '';
				if($('#perusahaan').val()==''|| $('#perusahaan').val()==undefined)
				{
					idPer = '';
				}
				else
				{
					idPer = $('#perusahaan').val();
				}
				
			    var idVen = '';
				if($('#vendor').val()==''|| $('#vendor').val()==undefined)
				{
					idVen = '';
				}
				else
        ...
        columnDefs:[
            {
                ...
                render: function(d) {
                    return '<a title="Compare" data-id="'+d+'" class="btn btn-action btn-primary btn-xs btn-add-compare"><i class="fa fa-plus-circle text-light"></i></a> &nbsp;'+
							'<a title="Detail" href="/report/patient/medical-check-up/detail/'+d+'" class="btn btn-action btn-primary btn-xs" data-id="'+d+'"><i class="fa fa-ellipsis-h"></i></a> &nbsp;'+
                            '<a title="Print" target="_blank" href="/report/patient/medical-check-up/print/'+d+'" data-id='+d+' class="btn btn-action btn-default btn-xs"><i class="fa fa-print"></i></a>';
                }
            }
        ]
    });
	...
	$('#btn-download-mcu').click(function() {
			...
			data.append('idPerusahaan',idPer);
			data.append('idVendor',idVen);
		 ...
		 $.ajax({
            url: baseUrl+"/report/patient/diseases-detail/export",
