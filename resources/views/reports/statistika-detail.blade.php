...
@section('ribbon')
    ...
    <ul class="breadcrumbs pull-left">
        <li><a>Report</a></li>
        <li><a href="/report/statistik-umum">{{ $parentMenu }}</a></li>
        <li><span>Tabel {{ $tabel }} - {{ $nilai }} (Total {{$total}})</span></li>
    </ul>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        ...
                                        <input type="hidden" class="form-control input-xs" id="tabel" value="{{ $tabel }}">
                                        <input type="hidden" class="form-control input-xs" id="nilai-tabel" value="{{ $nilai }}">
                                        <label for="" class="control-label col-md-4">@lang('mcu.input_date')</label>
                                        <div class="col-md-8">
                                            <div class="input-group input-daterange">
                                                <input value="{{($startDate)?$startDate:''}}" type="text" class="form-control form-control-sm" id="from-date" data-provide="datepicker" style="border-right-width: 1px">
                                                <div  class="input-group-addon">&nbsp;-&nbsp;</div>
                                                <input value="{{($endDate)?$endDate:''}}" type="text" class="form-control form-control-sm" id="to-date" data-provide="datepicker">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row">
                                        <label for="" class="control-label col-md-4">Statistika</label>
                                        <div class="col-md-8"><input type="text" class="form-control form-control-sm" readonly value="{{$tabel}} - {{$nilai}}"></div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group row">
...
$(document).ready(function () {
    ...
    var dataTable = $('#datatable').DataTable({
        ...
        ajax: {
            ...
            url: baseUrl+"/report/statistik-detail-datatables",
            type: 'GET',
            data:  function(d){
				var idPer = '';
        ...
        columnDefs:[
            {
                ...
                render: function(d) {
                    return '<a title="Compare" data-id="'+d+'" class="btn btn-action btn-primary btn-xs btn-add-compare"><i class="fa fa-plus-circle text-light"></i></a> &nbsp;'+
                            ...
                            '<a title="Print" target="_blank" href="/report/patient/medical-check-up/print/'+d+'" data-id='+d+' class="btn btn-action btn-outline-secondary btn-xs"><i class="fa fa-print"></i></a>';
                }
            }
        ]
    });
	...
	$('#btn-download-mcu').click(function() {
			...
			data.append('tabel',$('#tabel').val());
			data.append('nilai',$('#nilai-tabel').val());
			//d.tabel = $('#tabel').val();
            //d.nilai = $('#nilai-tabel').val();
			//console.log(data);
		 ...
		 $.ajax({
            ...
            url: baseUrl+"/report/patient/statistik-detail/export",
