...
if ($("#visitor_graph").length) {
    $.getJSON(baseUrl + "/report/statistik-event-sex", function (resp) {
        var male = [];
        var female = [];
        var categories = [];
        ...
        //console.log("TOTAL Data =", categories);
            ...
            series: [
                {
                    name: "MALE (L)",
                    // data: [
                    //     400, 470, 520, 500, 420, 350, 320, 400, 550, 600, 500,
                    //     420, 400,
                    // ],
                    data: male,
                ...
                },
                {
                    name: "FEMALE (P)",
                    // data: [
                    //     450, 520, 550, 400, 450, 500, 400, 450, 500, 450, 400,
                    //     500, 450,
                    // ],
                    data: female,
